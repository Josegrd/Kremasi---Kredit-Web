      ...
      <div className="bg-[#02063D] h-[100vh] overflow-hidden lg:overflow-auto">
        <div className="container text-white lg:mx-auto md:pt-44 py-28 md:py-0 lg:py-0">
          <div className="flex flex-wrap lg:flex-row-reverse md:flex-row-reverse">
            ...
            <div className="w-full md:w-1/2 self-end px-4 lg:w-1/2 text-left lg:mb-32 font-sans">
              <h2 className="text-2xl  lg:text-[32px] font-bold text-[#84CECF] mb-2">
                Hello Creditpeople!
              </h2>
              <h1 className="font-bold">
                <span className="text-5xl lg:text-8xl">Welcome to </span>{" "}
                <span className="text-[#84CECF] text-5xl lg:text-8xl">
                  <ReactTypingEffect text={["Kremasi", "Kredit Yuk!"]} />
                </span>
              </h1>
              <p className="max-w-md my-9 text-[14px] lg:text-[18px] opacity-80">
